...
{
    public partial class Aspiradoras : Form
    {
        public Aspiradoras()
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "" || comboBox2.Text == "" || comboBox4.Text == "" || comboBox9.Text == "")
            {
            ...
            if (!System.Text.RegularExpressions.Regex.IsMatch(comboBox9.Text, @"^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$"))
            {
            ...
            if (resultado == DialogResult.Yes)
            {
                ...
                string marcaequipo = comboBox9.Text;
        ...
        private void Aspiradoras_Load(object sender, EventArgs e)
        {
