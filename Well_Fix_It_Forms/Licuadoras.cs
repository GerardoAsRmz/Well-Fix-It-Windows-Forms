...
{
    public partial class Licuadoras : Form
    {
        public Licuadoras()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "" || comboBox2.Text == "" || comboBox4.Text == "" || comboBox8.Text == "")
            {
            ...
            if (!System.Text.RegularExpressions.Regex.IsMatch(comboBox8.Text, @"^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$"))
            {
            ...
            if (resultado == DialogResult.Yes)
            {
                ...
                string marcaequipo = comboBox8.Text;
        ...
        private void Licuadoras_Load(object sender, EventArgs e)
        {
