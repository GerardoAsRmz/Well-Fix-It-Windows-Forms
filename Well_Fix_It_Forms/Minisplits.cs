...
{
    public partial class Minisplits : Form
    {
        public Minisplits()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "" || comboBox2.Text == "" || comboBox4.Text == "" || comboBox3.Text == "")
            {
            ...
            if (resultado == DialogResult.Yes)
            {
                ...
                string marcaequipo = comboBox3.Text;
        ...
        private void Minisplits_Load(object sender, EventArgs e)
        {
