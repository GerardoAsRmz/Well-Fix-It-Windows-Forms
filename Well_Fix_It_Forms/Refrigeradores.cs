...
{
    public partial class Refrigeradores : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox2.Text == "" || comboBox3.Text == "" || comboBox4.Text == "" || comboBox1.Text == "")
            {
                MessageBox.Show("Por favor, llene todos los campos para un mejor servicio.", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            { 
                 ...
                 string categoria = "Refrigeradores";
                ...
                string marcaequipo = comboBox1.Text;
        ...
        private void Refrigeradores_Load(object sender, EventArgs e)
        {
