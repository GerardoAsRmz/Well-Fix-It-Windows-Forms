...
{
    public partial class Televisiones : Form
    {
        public Televisiones()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "" || comboBox3.Text == "" || comboBox4.Text == "" || comboBox2.Text == "")
            {
            ...
            if (resultado == DialogResult.Yes)
            {
                ...
                string marcaequipo = comboBox2.Text;
        ...
        private void Televisiones_Load(object sender, EventArgs e)
        {
