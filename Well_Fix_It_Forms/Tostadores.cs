...
{
    public partial class Tostadores : Form
    {
        public Tostadores()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "" || comboBox2.Text == "" || comboBox4.Text == "" || comboBox4.Text == "")
            {
            ...
            if (!System.Text.RegularExpressions.Regex.IsMatch(comboBox5.Text, @"^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$"))
            {
            ...
            string marcaequipo = comboBox5.Text;
        ...
        private void Tostadores_Load(object sender, EventArgs e)
        {
