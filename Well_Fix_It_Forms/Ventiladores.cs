...
{
    public partial class Ventiladores : Form
    {
        public Ventiladores()
        {
            InitializeComponent();
        ...
        private void Ventiladores_Load(object sender, EventArgs e)
        {
